(function() {
  var Validator, api_request, config, habilit, head, http, loginPortal, my_conf, my_cookie, my_globalPort, puts, version;
    ...
    if (my_session) {
      ...
      myvalidator.on('auth', function(entete) {
        ...
        proxy_request.addListener('response', __bind(function(proxy_response) {
          var hd, headers_retour, _ref;
          headers_retour = head.cloneHeaders(proxy_response.headers, saveHost);
          if (_ref = proxy_response.statusCode, __indexOf.call([300, 301, 302, 303, 304, 305, 306, 307, 308, 309], _ref) >= 0) {
